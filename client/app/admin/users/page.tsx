          ...
          <div className="flex flex-wrap items-end gap-3">
            <div className="min-w-[240px] flex-1">
              <label className="mb-1.5 block text-sm font-medium text-slate-700">
                ค้นหา (ชื่อผู้ใช้ / ตำแหน่ง / หน่วยงาน)
              </label>
              <input
                value={q}
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <thead className="border-b border-blue-700/20 bg-gradient-to-r from-sky-600 to-blue-600 text-white">
                <tr>
                  <th className="w-[60px] px-4 py-3 text-left font-semibold">ลำดับ</th>
                  ...
                  <th className="w-[260px] px-4 py-3 text-center font-semibold">การทำงาน</th>
                </tr>
              </thead>
