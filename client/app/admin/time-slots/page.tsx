                    ...
                    <tr key={slot.id} className="transition hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button type="button" onClick={() => openEdit(slot)} className="rounded-xl border border-amber-500 bg-amber-500 px-3 py-1.5 text-xs font-semibold text-white transition hover:border-amber-600 hover:bg-amber-600 disabled:opacity-50" disabled={busy}>แก้ไข</button>
                          <button type="button" onClick={() => deleteSlot(slot)} className="rounded-xl border border-red-500 bg-red-500 px-3 py-1.5 text-xs font-semibold text-white transition hover:border-red-600 hover:bg-red-600 disabled:opacity-50" disabled={busy}>ลบ</button>
                        </div>
                      </td>
                    </tr>
                  ))
